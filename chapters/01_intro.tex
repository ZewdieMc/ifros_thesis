...
\begin{itemize}
	\item Is LiDAR odometry alone sufficient to generate accurate map of complex environments?
	\item What are the limitations of Graph SLAM in generating consistent map especially in revisited locations?
	\item How effective is it to integrate LiDAR Inertial Odometry, Graph SLAM,and LiDAR Bundle Adjustment for generating globally consistent map of environments?
\end{itemize}
