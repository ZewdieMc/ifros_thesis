...
\begin{itemize}
	\item To develop robust LiDAR SLAM that maintains global consistency of map both for indoor and outdoor environments by integrating LiDAR Inertial odometry, graph SLAM, LiDAR bundle adjustment.
